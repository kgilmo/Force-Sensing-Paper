...
\centering
  ...
  \subfloat[]{%
    \includegraphics[width=.4\textwidth]{amp_sense_1}}\hfill
  \subfloat[]{%
    \includegraphics[width=.4\textwidth]{amp_sense_2}}\hfill
  \caption{}\label{fig:1}
\end{figure}

Scanning the power of the ODF laser varies the strength of the measurement. By comparing the peak of the curve to the background, the signal and the signal-to-noise can be extracted. From this, the sensitivity of the sequence is found. 
