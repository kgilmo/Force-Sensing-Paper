...
%Title of paper
\title{Force Sensing and Amplitude Detection with Ions in a Penning Trap}
...
\centering
  ...
  \subfloat[]{%
    \includegraphics[width=.2\textwidth]{lineshape_vs_drive}}\hfill
  \subfloat[]{%
    \includegraphics[width=.2\textwidth]{lineshape_vs_odf}}\\
  \subfloat[]{%
...
\centering
  ...
  \subfloat[]{%
    \includegraphics[width=.2\textwidth]{on_res_drive_t}}\hfill
  \subfloat[]{%
    \includegraphics[width=.2\textwidth]{on_res_odf_scan}}\hfill
  \subfloat[]{%
